...
export default function TopNavbar({ user, title, subtitle, onMenuClick }) {
    return (
        <header className="sticky top-0 z-30 border-b border-zinc-200 bg-white/95 backdrop-blur">
            <div className="flex min-w-0 py-3 sm:py-0 flex-1 items-center justify-end gap-2 sm:gap-3 px-4 sm:px-6 lg:px-8">
                <button
                    type="button"
                    onClick={onMenuClick}
                ...
                <div className="min-w-0 flex-1 py-3 hidden sm:block">
    ...
    {/* Global Search */}
    <div className="min-w-0 flex-1 sm:max-w-[320px] lg:max-w-[380px]">
        <GlobalSearch />
    </div>
